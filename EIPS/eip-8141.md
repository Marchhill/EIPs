...
Its per-fork `keccak256` code hash is `0xda42f0d11838c4c0c3129b8b8e93e9718127ad6b315e517e1088125707c4d45c`. An annotated assembly listing that assembles byte-for-byte to this bytecode, together with the bytecode and hash, is given in the [canonical paymaster assets file](../assets/eip-8141/canonical-paymaster.md); all three are reproducible from the reference assembler.
